...
[^1]:My portfolio is pretty simple, I focus on the back-end to ensure things are working effectively and easy to implement saving time and money. I know basic front-end technologies but I prefer to work on the back-end using Java or Python. Most of my code is on a private cloud space. If you're an employer wanting to see more coding examples please ask for my availablity so we can schedule an interview. 
